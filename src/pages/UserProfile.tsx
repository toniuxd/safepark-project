            ...
            <div className="rounded-[34px] border border-white/5 bg-[linear-gradient(180deg,rgba(25,33,89,0.55)_0%,rgba(12,16,42,0.82)_100%)] p-6 shadow-[0_18px_40px_rgba(0,0,0,0.45)] space-y-6">
              ...
              <div className="flex flex-col items-center gap-3 pt-2">
                <div className="relative">
                  <div className="w-20 h-20 rounded-full bg-black/25 border-2 border-white/10 flex items-center justify-center">
              ...
              <section className="space-y-3">
                ...
                <div className="space-y-2">
                  <FieldRow label="Full Name">
                    {editing ? (
                      <InputField value={fullName} onChange={(e) => setFullName(e.target.value)} className="bg-black/25 border-white/10" />
                    ) : (
                  ...
                  <FieldRow label="Phone">
                    {editing ? (
                      <InputField value={phone} onChange={(e) => setPhone(e.target.value)} className="bg-black/25 border-white/10" />
                    ) : (
              ...
              <section className="space-y-3 pt-2">
                <button className="w-full bg-black/25 rounded-card p-4 flex items-center gap-3 border border-white/10 text-foreground text-sm font-medium">
                  <Lock size={16} className="text-sp-text-secondary" />
                  Change Password
                </button>

                <PillButton onClick={handleLogout} className="h-14 bg-gradient-to-r from-cyan-300 to-cyan-400 text-slate-900 shadow-[0_0_24px_rgba(34,211,238,0.35)] flex items-center justify-center gap-2">
...
function FieldRow({ label, children }: { label: string; children: React.ReactNode }) {
  return (
    <div className="bg-black/25 rounded-card px-4 border border-white/10">
...
function ToggleRow({
  ...
  return (
    <div className="bg-black/25 rounded-card p-4 flex items-center gap-3 border border-white/10">
